...
public class AnomalieControlleur {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<Anomalie> getAnomalie(@PathVariable(value="refAnomalie") Long refAnomalie) throws ResourceNotFoundException {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Anomalie> updateAnoamalie(@PathVariable (value = "refAnomalie", required = false) Long refAnomalie, @RequestBody Anomalie anomalieRequest ) throws ResourceNotFoundException {
        anomalieRequest.setRefAnomalie(refAnomalie);
        return ResponseEntity.ok().body(anomalieService.updateAnomalie(anomalieRequest));
    }

    @DeleteMapping("/{id}")
    public String deleteAnomalie(@PathVariable(value="refAnomalie") Long refAnomalie){
